...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: zFqYeIGWBdTd/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__qfDw)}
      >
        <div className={classNames(projectcss.all, sty.freeBox___0E7)}>
          <div className={classNames(projectcss.all, sty.freeBox__n7DaC)}>
            {p.renderPlasmicSlot({
