...
import sty from "./PlasmicFeatureCard.module.css"; // plasmic-import: WuiK6Q0G2Qn/css
  ...
  return (
    ...
    >
      {(hasVariant(variants, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__t0ZDb, {
            [sty.freeBoxlong__t0ZDbW2JG0]: hasVariant(variants, "long", "long")
          })}
        >
          <div
            className={classNames(projectcss.all, sty.freeBox__folal, {
              [sty.freeBoxlong__folalW2JG0]: hasVariant(
                variants,
                "long",
                "long"
              )
          ...
          >
            {p.renderPlasmicSlot({
              defaultContents: (
                <svg
                  className={classNames(projectcss.all, sty.svg___3SFni)}
                  role={"img"}
                />
              ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___1Cf95, {
          [sty.freeBoxlong___1Cf95W2JG0]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
      ...
      {(hasVariant(variants, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__n0WpB, {
            [sty.freeBoxlong__n0WpBw2JG0]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__ynGg)}
                role={"img"}
              />
            ),
