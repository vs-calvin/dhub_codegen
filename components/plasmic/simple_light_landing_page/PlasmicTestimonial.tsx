...
import Avatar from "../../Avatar"; // plasmic-import: HJPGgYLZhiYt/component
...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: cUMvV6WTEqcd/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: NLWj_ux-vnHA/icon
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__c7ZyR)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__gj7Ws)}
        >
          <div
            className={classNames(
              projectcss.all,
