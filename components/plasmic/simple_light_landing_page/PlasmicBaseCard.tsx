...
import sty from "./PlasmicBaseCard.module.css"; // plasmic-import: -kuylHrdU3pq/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__vgqqy, {
          [sty.freeBoxlong__vgqqyK4Ev]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__m3NH, {
            [sty.freeBoxlong__m3NHk4Ev]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__ozPd0)}
                role={"img"}
              />
            ),
