...
import BaseCard from "../../BaseCard"; // plasmic-import: -kuylHrdU3pq/component
...
import sty from "./PlasmicPlan.module.css"; // plasmic-import: T0Uzv7heB-kN/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__fYuVd)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__nzql)}
        >
          {p.renderPlasmicSlot({
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__uNl)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet___7RjGy)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__wyxEg)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__sTXa9)}
                />
              </p.Stack>
            ),
          ...
          <div className={classNames(projectcss.all, sty.freeBox__kbp7)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__fytDd)}
